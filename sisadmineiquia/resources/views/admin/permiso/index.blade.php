...
<div class="row">
    <div class="col-lg-12">
        ...
        <label><a href="{{url('admin/permiso/reporte')}}" role="button" class="btn btn-success btn-lg"><i class="glyphicon glyphicon-plus"></i> Reporte</a></label>
...
<div class="row">
	<div class="col-lg-11 col-md-10 col-sm-10 col-xs-12"><br>
