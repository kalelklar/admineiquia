    ...
    <li>
        <a href="#" data-toggle="collapse" data-target="#demo3"><i class="glyphicon glyphicon-equalizer"></i> Gestionar Puestos <i class="fa fa-angle-left pull-right"></i></a>
        <ul id="demo3" class="collapse">
            <li>
                <a href="{{url('/admin/puesto/create')}}"><i class="glyphicon glyphicon-pushpin"></i> Agregar Puesto</a>
            </li>
            <li>
                <a href="{{url('/admin/perfilpuesto')}}"><i class="fa fa-users"></i> Administrar Perfiles</a>
            </li>
            <li>
                <a href="{{url('/admin/puesto')}}"><i class="glyphicon glyphicon-object-align-right"></i> Administrar Puestos</a>
            </li>
            
        </ul>
    </li>
    <li>
        <a href="javascript:;" data-toggle="collapse" data-target="#demo4"><i class="glyphicon glyphicon-ok"></i> Control de Asistencias<i class="fa fa-angle-left pull-right"></i></a>
    ...
    <li>
        <a href="#" data-toggle="collapse" data-target="#demo5"><i class="glyphicon glyphicon-list-alt"></i> Gestionar Permisos <i class="fa fa-angle-left pull-right"fa fa-angle-left pull-right></i></a>
    ...
    <li>
        ...
        <ul id="demo6" class="collapse">
            ...
            <li>
                <a href="{{url('/admin/acuerdos')}}"><i class="glyphicon glyphicon-saved"></i> Administar Acuerdos</a>
            </li>
        </ul>
    </li>
